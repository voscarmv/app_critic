...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create opinion' do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { content: @opinion.content, user_id_id: @opinion.user_id_id } }
    end
  ...
  test 'should update opinion' do
    patch opinion_url(@opinion), params: { opinion: { content: @opinion.content, user_id_id: @opinion.user_id_id } }
